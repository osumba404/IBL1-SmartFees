                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('enrollment_open') is-invalid @enderror" id="enrollment_open" name="enrollment_open" required>
                            <option value="yes" {{ old('enrollment_open', $course->enrollment_open ? 'yes' : 'no') == 'yes' ? 'selected' : '' }}>Open</option>
                            <option value="no" {{ old('enrollment_open', $course->enrollment_open ? 'yes' : 'no') == 'no' ? 'selected' : '' }}>Closed</option>
                        </select>
